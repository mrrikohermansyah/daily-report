...
const locations = [
  ...
  { value: "Blasting Painting", label: "Blasting Painting" },
  ...
  { value: "Jetty Area", label: "Jetty Area" },
  ...
  { value: "PCC Building", label: "PCC Building" },
  { value: "Red Office", label: "Red Office" },
  { value: "Rest Area", label: "Rest Area" },
  { value: "Rigging Store", label: "Rigging Store" },
  { value: "Security Front", label: "Security Front" },
  { value: "Sec Pos 1", label: "Sec Pos 1" },
  { value: "Sec Pos 2", label: "Sec Pos 2" },
  { value: "Sec Pos 3", label: "Sec Pos 3" },
  { value: "Sec Pos 4", label: "Sec Pos 4" },
  { value: "Sec Pos 5", label: "Sec Pos 5" },
  { value: "Sec Pos 6", label: "Sec Pos 6" },
  { value: "Sec Pos 7", label: "Sec Pos 7" },
  { value: "Sec Pos 8", label: "Sec Pos 8" },
  ...
  { value: "White Office 1st Fl", label: "White Office 1st Fl" },
  { value: "White Office 2nd Fl", label: "White Office 2nd Fl" },
  { value: "White Office 3rd Fl", label: "White Office 3rd Fl" },
  { value: "Welding School", label: "Welding School" },
  { value: "Workshop 6", label: "Workshop 6" },
  { value: "Workshop 7", label: "Workshop 7" },
  { value: "Workshop 8", label: "Workshop 8" },
  { value: "Workshop 9", label: "Workshop 9" },
  { value: "Workshop 10", label: "Workshop 10" },
  { value: "Workshop 11", label: "Workshop 11" },
  { value: "Workshop 12", label: "Workshop 12" },
